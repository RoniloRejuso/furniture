...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Title
        $this->Cell(0, 10, 'Orders Report', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        // Line break
        $this->Ln(10);
    }
...
if ($result->num_rows > 0) {
    ...
    $pdf->Cell(40, 10, 'Amount Change', 1, 0, 'C');
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $pdf->Cell(40, 10, $row["amount_change"], 1, 0, 'C');
...
// Close and output PDF document
$outputPath = __DIR__ . '/uploads/orders_report.pdf';
...
echo "<script>";
echo "alert('PDF report generated. Check uploads folder for the orders report.');";
