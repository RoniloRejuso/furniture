...
<div class="living_room_section">
   <div class="container">
      <div class="row">
         ...
         <?php
            // Assuming you have PHP logic here to fetch living room products
            $products = get_living_room_products(); // Function to get living room products from the database
